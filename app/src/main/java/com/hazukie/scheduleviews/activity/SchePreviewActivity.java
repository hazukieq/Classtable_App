...
public class SchePreviewActivity extends BaseActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        scheContainer.post(() -> {
            ...
            uiProcessor=new ScheUIProcessor(SchePreviewActivity.this,scheContainer,mwidth,totalClass);
    ...
    public static void startActivityWithSche(Context context, int total,String timeName,List<ClassLabel> clss) {
        Intent intent = new Intent(context, SchePreviewActivity.class);
